...
@click.option("--open", "open_browser", is_flag=True, default=False,
              help="Open aipassport.web.app in your browser after generating.")
def run(days: int, output: str, model: str | None, no_codex: bool, codex_all: bool,
        verbose: bool, open_browser: bool):
    ...
    combined_metrics = {"claude_code": metrics}
    if codex_metrics:
    ...
    click.echo(f"AI Engineering Score: {profile.summary.ai_engineering_score}/100")
    click.echo(f"\nView your passport:")
    click.echo(f"  https://aipassport.web.app  →  drag {out_path.name} onto the page")
    if open_browser:
        webbrowser.open("https://aipassport.web.app")
